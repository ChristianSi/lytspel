...
* **phoneme-map.csv**: mapping between
  ...
  notation used by eSpeak for British and American English, and the
  standard spellings used by Lytspel for each phoneme. Used by `mergeprons`
  and `lytspelify`.
...
* Download the [CMU Pronouncing
  ...
  the file.
* Download the [Moby Pronunciation
  List](http://www.gutenberg.org/ebooks/3205) -- click on "More Files…" and
  download "files.zip". Unzip it within the "data" directory and rename the
  unpacked directory to "moby".
